...
the BIDS sourcedata directory. The main table (referred to in the project's :doc:`credentials as searchTable <../support-tools/index>`) contains the elements described 
