...
the BIDS sourcedata directory. The main table (referred to in the project's :doc:`credentials as searchTable <../support-tools/read_credentials>`) contains the elements described 
