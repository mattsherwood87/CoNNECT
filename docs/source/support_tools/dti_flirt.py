...
# ******************* s3 bucket check ********************
def dti_flirt(IN_FILE,DATA_DIR,FLIRT_PARAMS,*args,**kwargs):
    """
    ...
    try:
        ...
        if refImageFile:
            ...
            for secFile in secFiles:
                ...
                applyBidsLabels = get_bids_labels(secFile)
                applyBidsLabels = refImageParams['output_bids_labels'].copy()
                applyBidsLabels['suffix'] = 'dwi_' + get_bids_labels(secFile)['suffix']
